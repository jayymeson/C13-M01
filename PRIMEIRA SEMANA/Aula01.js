...
// EXERCICIO DE FIXAÇÃO AULA-01


// const prompt = require('prompt-sync')();

// const nome = prompt(`Olá, qual seu nome? `);
// const dia = +prompt(`${nome}, qual dia você nasceu? `);
// const mes = +prompt(`${nome}, agora me diz o mês... `);
// const ano = +prompt(`Por último, me diz o ano: `);

// const anoAtu = 2022
// const mesAtu = 03
// const diaAtu = 04
// const diaVi = anoAtu - ano
// const diaVi2 = mesAtu - mes
// const diaVi3 = dia - diaAtu
// const diaTotal = diaVi * 365 + diaVi2 * 30 + diaVi3 


// console.log(`${diaVi} anos`);
// console.log(`${diaVi2} meses`);
// console.log(`e ${diaVi3} dias`);

// console.log(`Você viveu ${diaTotal}`)
